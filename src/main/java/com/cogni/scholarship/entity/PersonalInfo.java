...
public class PersonalInfo implements Serializable {
	...
	@NotNull
	@Pattern(regexp="(^$|[0-9]{14})", message="enter a valid number and length must be 14 ")
...
//-----------------------------------------------------------------------------------------
	...
	public PersonalInfo( String username, String sName, String fName, String dob, String gender,
			String catagory, String aadhar_no, String phone, String email, String city, String state, int pin,
			String hs_school, String hs_board, String hs_year, String hs_mars, String h_school, String h_board,
			String h_year, String h_mars, String bName, String ifsc, String branch, String ac_no) {
		super();
